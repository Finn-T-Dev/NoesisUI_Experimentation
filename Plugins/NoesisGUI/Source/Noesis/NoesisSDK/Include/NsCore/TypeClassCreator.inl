...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline typename TypeClassCreator::TypePropertyCreator TypeClassCreator::Prop(const char* name)
{
    // This constructor is used in Studio to add metadata to DPs that do not have a corresponding
    // reflection property. Without this, we are forced to add at least a getter
    TypeProperty* p = new TypePropertyOffsetEvent(Symbol::Static(name), 0);
    mTypeClass->AddProperty(p);
    return TypePropertyCreator(p);
}
