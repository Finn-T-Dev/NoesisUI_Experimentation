...
#ifndef __GUI_CONDITIONBEHAVIOR_H__
#define __GUI_CONDITIONBEHAVIOR_H__
...
///    </Grid>
////////////////////////////////////////////////////////////////////////////////////////////////////
class NS_GUI_INTERACTIVITY_API ConditionBehavior: public BehaviorT<TriggerBase>
{
public:
    ConditionBehavior();
    ~ConditionBehavior();

    /// Gets or sets the ConditionalExpression object on the behavior
    //@{
...
public:
    static const DependencyProperty* ConditionProperty;
...
private:
    void OnPreviewInvoke(BaseComponent* sender, const PreviewInvokeEventArgs& e);
