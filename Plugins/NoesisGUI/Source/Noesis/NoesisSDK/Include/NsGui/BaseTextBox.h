...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Provides data for the TextChanged routed events.
////////////////////////////////////////////////////////////////////////////////////////////////////
struct TextChange
{
    int offset;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Arguments to be passed in the TextChanged event
////////////////////////////////////////////////////////////////////////////////////////////////////
struct TextChangedEventArgs : public RoutedEventArgs
{
    Vector<TextChange, 1> changes;

    TextChangedEventArgs(BaseComponent* source, ArrayRef<TextChange> changes_);
};

typedef Delegate<void (BaseComponent*, const TextChangedEventArgs&)> TextChangedEventHandler;
...
public:
    ...
    UIElement::RoutedEvent_<TextChangedEventHandler> TextChanged();
...
protected:
    ...
    void RaiseTextChanged(const TextChangedEventArgs& e);
