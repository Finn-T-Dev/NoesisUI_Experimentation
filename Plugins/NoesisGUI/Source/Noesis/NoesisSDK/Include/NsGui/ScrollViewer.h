...
public:
    ...
    /// Gets value that indicates whether scrolled content can render outside the bounds of the
    /// ScrollViewer
    static bool GetCanContentRenderOutsideBounds(const DependencyObject* element);
    /// Sets value that indicates whether scrolled content can render outside the bounds of the
    /// ScrollViewer
    static void SetCanContentRenderOutsideBounds(DependencyObject* element, bool value);
    ...
    /// Gets or sets a value that indicates whether scrolled content can render outside the bounds
    /// of the ScrollViewer
    //@}
    bool GetCanContentRenderOutsideBounds() const;
    void SetCanContentRenderOutsideBounds(bool value);
    //@}
...
public:
    ...
    static const DependencyProperty* CanContentRenderOutsideBoundsProperty;
