...
private:
    bool RegisterObject(BaseComponent* object);
    void UnregisterObject(DependencyObject* object);
    void OnObjectDestroyed(DependencyObject* d);

private:
    typedef HashMap<String, Pair<BaseComponent*, bool>> NameObjectMap;
