...
NS_IMPLEMENT_REFLECTION(StoryboardAction, "Noesis.Interactivity.StoryboardAction")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("Storyboard", &StoryboardAction::GetStoryboard, &StoryboardAction::SetStoryboard)
