...
NS_IMPLEMENT_REFLECTION(InvokeCommandAction, "Noesis.Interactivity.InvokeCommandAction")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("Command", &InvokeCommandAction::GetCommand, &InvokeCommandAction::SetCommand)
        .Meta<Noesis::StudioOrder>(1);
    NsProp("CommandParameter", &InvokeCommandAction::GetCommandParameter,
        &InvokeCommandAction::SetCommandParameter)
    ...
    NsProp("PassEventArgsToCommand", &InvokeCommandAction::GetPassEventArgsToCommand,
        ...
        .Meta<Noesis::StudioName>("Use Event Args");
    NsProp("EventArgsParameterPath", &InvokeCommandAction::GetEventArgsParameterPath,
        &InvokeCommandAction::SetEventArgsParameterPath)
        .Meta<Noesis::StudioOrder>(4);
    NsProp("EventArgsConverter", &InvokeCommandAction::GetEventArgsConverter,
        &InvokeCommandAction::SetEventArgsConverter)
        .Meta<Noesis::StudioOrder>(5);
    NsProp("EventArgsConverterParameter", &InvokeCommandAction::GetEventArgsConverterParameter,
        &InvokeCommandAction::SetEventArgsConverterParameter)
