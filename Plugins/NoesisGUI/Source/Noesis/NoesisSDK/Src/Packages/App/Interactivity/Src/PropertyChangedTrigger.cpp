...
NS_IMPLEMENT_REFLECTION(PropertyChangedTrigger, "Noesis.Interactivity.PropertyChangedTrigger")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("Binding", &PropertyChangedTrigger::GetBinding, &PropertyChangedTrigger::SetBinding)
