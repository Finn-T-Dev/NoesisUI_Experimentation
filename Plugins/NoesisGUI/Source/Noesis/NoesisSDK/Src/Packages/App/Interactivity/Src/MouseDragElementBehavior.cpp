...
NS_IMPLEMENT_REFLECTION(MouseDragElementBehavior, "Noesis.Interactivity.MouseDragElementBehavior")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("X", &MouseDragElementBehavior::GetX, &MouseDragElementBehavior::SetX)
        .Meta<Noesis::StudioOrder>(0);
    NsProp("Y", &MouseDragElementBehavior::GetY, &MouseDragElementBehavior::SetY)
        .Meta<Noesis::StudioOrder>(1);
    NsProp("ConstrainToParentBounds", &MouseDragElementBehavior::GetConstrainToParentBounds,
        &MouseDragElementBehavior::SetConstrainToParentBounds)
