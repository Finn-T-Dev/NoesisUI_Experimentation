...
////////////////////////////////////////////////////////////////////////////////////////////////////
static const Noesis::TypeProperty* FindEventInternal(Noesis::Symbol eventName,
    const Noesis::TypeClass* type)
{
    while (type != 0)
    {
...
void EventTriggerBase::RegisterEvent(BaseComponent* source, const char* eventName)
{
    if (source != 0 && !Noesis::StrIsNullOrEmpty(eventName))
    {
        ...
        const Noesis::TypeProperty* event = FindEventInternal(eventId, type);
        if (event != 0)
        {
...
NS_IMPLEMENT_REFLECTION(EventTriggerBase, "Noesis.Interactivity.EventTriggerBase")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("SourceName", &EventTriggerBase::GetSourceName, &EventTriggerBase::SetSourceName)
        .Meta<Noesis::StudioOrder>(0)
        .Meta<Noesis::StudioProp>("TargetProperty", Noesis::TypeOf<Noesis::UIElement>())
        .Meta<Noesis::StudioName>("Source");
    NsProp("SourceObject", &EventTriggerBase::GetSourceObject, &EventTriggerBase::SetSourceObject)
    ...
    data->RegisterProperty<Noesis::Ptr<BaseComponent>>(SourceNameResolverProperty,
        ".SourceNameResolver", Noesis::PropertyMetadata::Create(
            Noesis::Ptr<BaseComponent>(Noesis::DependencyProperty::GetUnsetValue()),
            Noesis::PropertyChangedCallback(
    [](Noesis::DependencyObject* d, const Noesis::DependencyPropertyChangedEventArgs&)
    {
        EventTriggerBase* trigger = Noesis::DynamicCast<EventTriggerBase*>(d);
