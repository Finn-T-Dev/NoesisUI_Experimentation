...
///    </Grid>
////////////////////////////////////////////////////////////////////////////////////////////////////
class NS_APP_INTERACTIVITY_API ChangePropertyAction: public TargetedTriggerActionT<Noesis::BaseComponent>
{
public:
...
protected:
    ...
    //@{
    void OnTargetChanged(Noesis::BaseComponent* oldTarget,
        Noesis::BaseComponent* newTarget) override;
    //@}
