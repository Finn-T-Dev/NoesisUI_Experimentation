...
NS_IMPLEMENT_REFLECTION(GamepadTrigger, "NoesisGUIExtensions.GamepadTrigger")
{
    ...
    NsProp("Button", &GamepadTrigger::GetButton, &GamepadTrigger::SetButton)
        .Meta<Noesis::StudioOrder>(0);
    NsProp("FiredOn", &GamepadTrigger::GetFiredOn, &GamepadTrigger::SetFiredOn)
        .Meta<Noesis::StudioOrder>(2);
    NsProp("HandleWhenFired", &GamepadTrigger::GetHandleWhenFired, &GamepadTrigger::SetHandleWhenFired)
        .Meta<Noesis::StudioOrder>(3);
    NsProp("ActiveOnFocus", &GamepadTrigger::GetActiveOnFocus, &GamepadTrigger::SetActiveOnFocus)
