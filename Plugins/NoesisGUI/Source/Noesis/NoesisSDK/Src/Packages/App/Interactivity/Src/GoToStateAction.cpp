...
////////////////////////////////////////////////////////////////////////////////////////////////////
GoToStateAction::GoToStateAction(): mStateTarget(0)
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
static bool HasStateGroup(Noesis::FrameworkElement* element)
{
    if (element != 0)
    {
        Noesis::VisualStateGroupCollection* groups =
            Noesis::VisualStateManager::GetVisualStateGroups(element);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
static bool ShouldWalkTree(Noesis::FrameworkElement* element)
{
    if (element == 0)
    {
        return false;
    ...
    if (Noesis::DynamicCast<Noesis::UserControl*>(element) != 0 ||
        Noesis::DynamicCast<Noesis::Component*>(element) != 0)
    {
        return false;
    }
    if (element->GetParent() == 0)
    {
        ...
        if (p == 0 || (Noesis::DynamicCast<Noesis::Control*>(p) == 0 &&
            Noesis::DynamicCast<Noesis::ContentPresenter*>(p) == 0))
        {
            return false;
        }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
static Noesis::FrameworkElement* FindStateGroup(Noesis::FrameworkElement* context)
{
    if (context != 0)
    {
        ...
        if (HasStateGroup(current))
        {
            ...
            if (parent != 0 && (
                    Noesis::DynamicCast<Noesis::UserControl*>(parent) != 0 ||
                    Noesis::DynamicCast<Noesis::Component*>(parent) != 0))
            {
                return parent;
            }
...
void GoToStateAction::Invoke(BaseComponent*)
{
    ...
    {
        // Find VisualStateManager
        if (mStateTarget == 0)
        {
            if (GetTargetObject() == 0 && Noesis::StrIsNullOrEmpty(GetTargetName()))
            {
                mStateTarget = FindStateGroup(Noesis::DynamicCast<Noesis::FrameworkElement*>(
                    GetAssociatedObject()));
            }
            else
            {
        ...
        // Do nothing if we didn't find the VisualStateManager
        if (mStateTarget == 0) return;
        ...
        if (!Noesis::StrIsNullOrEmpty(stateName))
        {
            ...
            if (Noesis::DynamicCast<Noesis::Control*>(mStateTarget) != 0 ||
                Noesis::DynamicCast<Noesis::Component*>(mStateTarget) != 0)
            {
                Noesis::VisualStateManager::GoToState(mStateTarget, stateId, useTransitions);
            }
            else
            {
...
NS_IMPLEMENT_REFLECTION(GoToStateAction, "Noesis.Interactivity.GoToStateAction")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("StateName", &GoToStateAction::GetStateName, &GoToStateAction::SetStateName)
        .Meta<Noesis::StudioOrder>(1)
        .Meta<Noesis::StudioProp>("VisualStateProperty")
        .Meta<Noesis::StudioName>("State");
    NsProp("UseTransitions", &GoToStateAction::GetUseTransitions, &GoToStateAction::SetUseTransitions)
