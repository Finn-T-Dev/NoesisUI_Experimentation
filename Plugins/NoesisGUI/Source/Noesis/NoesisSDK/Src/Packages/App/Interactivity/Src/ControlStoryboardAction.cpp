...
NS_IMPLEMENT_REFLECTION(ControlStoryboardAction, "Noesis.Interactivity.ControlStoryboardAction")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("ControlStoryboardOption", &ControlStoryboardAction::GetControlStoryboardOption,
        &ControlStoryboardAction::SetControlStoryboardOption)
        .Meta<Noesis::StudioOrder>(0)
        .Meta<Noesis::StudioName>("Option");
  #endif
...
NS_IMPLEMENT_REFLECTION_ENUM(ControlStoryboardOption, "Noesis.Interactivity.ControlStoryboardOption")
{
