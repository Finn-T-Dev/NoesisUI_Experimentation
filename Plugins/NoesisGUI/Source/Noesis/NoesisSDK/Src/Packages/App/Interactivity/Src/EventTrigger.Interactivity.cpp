...
NS_IMPLEMENT_REFLECTION(NoesisApp::EventTrigger, "Noesis.Interactivity.EventTrigger")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("EventName", &EventTrigger::GetEventName, &EventTrigger::SetEventName)
        .Meta<Noesis::StudioProp>("EventProperty",
            [](Noesis::BaseComponent* instance) -> Noesis::BaseComponent*
            {
                EventTrigger* trigger = Noesis::DynamicCast<EventTrigger*>(instance);
