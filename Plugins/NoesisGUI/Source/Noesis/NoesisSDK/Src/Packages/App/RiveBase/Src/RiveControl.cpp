...
NS_IMPLEMENT_REFLECTION(RiveControl, "NoesisGUIExtensions.RiveControl")
{
    ...
    NsMeta<Noesis::StudioDesc>("Renders a Rive file");
    NsMeta<Noesis::StudioHelpUri>("https://www.noesisengine.com/docs/App.RiveBase._RiveControl.html");
    NsMeta<Noesis::StudioIcon>(Noesis::Uri::Pack("Rive", "#Rive-Icons"), 0xE900);
  #endif
