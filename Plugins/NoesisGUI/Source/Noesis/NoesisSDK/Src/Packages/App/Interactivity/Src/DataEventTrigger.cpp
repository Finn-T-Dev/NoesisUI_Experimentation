...
NS_IMPLEMENT_REFLECTION(DataEventTrigger, "NoesisGUIExtensions.DataEventTrigger")
{
    ...
    NsProp("Source", &DataEventTrigger::GetSource, &DataEventTrigger::SetSource)
        .Meta<Noesis::StudioOrder>(0)
        .Meta<Noesis::StudioName>("Data Source");
    NsProp("EventName", &DataEventTrigger::GetEventName, &DataEventTrigger::SetEventName)
        .Meta<Noesis::StudioOrder>(1)
        .Meta<Noesis::StudioName>("Event")
        .Meta<Noesis::StudioProp>("EventProperty",
            [](Noesis::BaseComponent* instance) -> Noesis::BaseComponent*
            {
                DataEventTrigger* trigger = Noesis::DynamicCast<DataEventTrigger*>(instance);
                return trigger ? trigger->GetSource() : nullptr;
            });
  #endif
