...
NS_IMPLEMENT_REFLECTION(MediaElement, "MediaElement")
{
    ...
    NsMeta<Noesis::StudioDesc>("Renders video");
    NsMeta<Noesis::StudioHelpUri>("https://www.noesisengine.com/docs/App.MediaElement._MediaElement.html");
    NsMeta<Noesis::StudioIcon>(Noesis::Uri::Pack("Media", "#Media-Icons"), 0xE900);

    NsProp("Source", &MediaElement::GetSource, &MediaElement::SetSource)
        .Meta<Noesis::StudioOrder>(0);
    NsProp("Stretch", &MediaElement::GetStretch, &MediaElement::SetStretch)
        .Meta<Noesis::StudioOrder>(1);
    NsProp("StretchDirection", &MediaElement::GetStretchDirection, &MediaElement::SetStretchDirection)
        .Meta<Noesis::StudioOrder>(2, false);
    NsProp("Volume", &MediaElement::GetVolume, &MediaElement::SetVolume)
        .Meta<Noesis::StudioOrder>(3)
        .Meta<Noesis::StudioRange>(0, 1);
    ...
    NsProp("SpeedRatio", &MediaElement::GetSpeedRatio, &MediaElement::SetSpeedRatio)
        .Meta<Noesis::StudioOrder>(4, false)
        .Meta<Noesis::StudioMin>(0);
    NsProp("Balance", &MediaElement::GetBalance, &MediaElement::SetBalance)
        .Meta<Noesis::StudioOrder>(5, false)
        .Meta<Noesis::StudioRange>(-1, 1);
    NsProp("IsMuted", &MediaElement::GetIsMuted, &MediaElement::SetIsMuted)
        .Meta<Noesis::StudioOrder>(6, false);
    NsProp("ScrubbingEnabled", &MediaElement::GetScrubbingEnabled, &MediaElement::SetScrubbingEnabled)
        .Meta<Noesis::StudioOrder>(7, false);
    NsProp("LoadedBehavior", &MediaElement::GetLoadedBehavior, &MediaElement::SetLoadedBehavior)
        .Meta<Noesis::StudioOrder>(8, false);
    NsProp("UnloadedBehavior", &MediaElement::GetUnloadedBehavior, &MediaElement::SetUnloadedBehavior)
        .Meta<Noesis::StudioOrder>(9, false);
