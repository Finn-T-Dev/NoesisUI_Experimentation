...
NoesisApp::DataTrigger::DataTrigger(): mSourceType(0),
    mBinding(Noesis::DependencyProperty::GetUnsetValue()),
    mValue(Noesis::DependencyProperty::GetUnsetValue()), mComparison(ComparisonConditionType_Equal)
{
}
...
void NoesisApp::DataTrigger::EvaluateBindingChange()
{
    ...
    {
        Noesis::BindingOperations::EnsureBindingValue(this, BindingProperty);
        Noesis::BindingOperations::EnsureBindingValue(this, ComparisonProperty);
...
bool NoesisApp::DataTrigger::UpdateSourceType()
{
    ...
    const Noesis::Type* type = binding != 0 ? Noesis::ComparisonLogic::ExtractBoxedType(binding) : 0;
    ...
    if (mSourceType != type)
    {
        ...
        if (mSourceType != 0)
        {
            ...
            mComparator = Noesis::ComparisonLogic::Create(mSourceType);
        }
    }
...
bool NoesisApp::DataTrigger::UpdateTriggerValue()
{
    ...
    const Noesis::Type* type = value != 0 ? Noesis::ComparisonLogic::ExtractBoxedType(value) : 0;
...
NS_IMPLEMENT_REFLECTION(NoesisApp::DataTrigger, "Noesis.Interactivity.DataTrigger")
{
  #ifdef NS_HAVE_STUDIO
    NsProp("Comparison", &DataTrigger::GetComparison, &DataTrigger::SetComparison)
        .Meta<Noesis::StudioOrder>(1);
    NsProp("Value", &DataTrigger::GetValue, &DataTrigger::SetValue)
