...
NS_IMPLEMENT_REFLECTION(KeyTrigger, "Noesis.Interactivity.KeyTrigger")
{
    ...
    NsProp("FiredOn", &KeyTrigger::GetFiredOn, &KeyTrigger::SetFiredOn)
        .Meta<Noesis::StudioOrder>(2);
    NsProp("ActiveOnFocus", &KeyTrigger::GetActiveOnFocus, &KeyTrigger::SetActiveOnFocus)
...
NS_IMPLEMENT_REFLECTION_ENUM(KeyTriggerFiredOn, "Noesis.Interactivity.KeyTriggerFiredOn")
{
