...
public:
	...
	using FPermutationDomain = TShaderPermutationDomain<FEffect, FLinearColor, FPatternLinear, FPatternIgnoreAlpha, FGammaCorrection>;
	...
	static bool ShouldCompilePermutation(const FGlobalShaderPermutationParameters& Parameters)
	{
		...
		if (!NoesisShaderHasPattern[Permutation.Get<FEffect>()] && (Permutation.Get<FLinearColor>() || Permutation.Get<FPatternLinear>() || Permutation.Get<FPatternIgnoreAlpha>()))
		{
			return false;
		}
...
public:
	...
	class FLinearColor : SHADER_PERMUTATION_BOOL("LINEAR_COLOR");
	class FGammaCorrection : SHADER_PERMUTATION_BOOL("GAMMA_CORRECTION");
	using FPermutationDomain = TShaderPermutationDomain<FEffect, FLinearColor, FGammaCorrection>;
...
public:
	...
	class FGammaCorrection : SHADER_PERMUTATION_BOOL("GAMMA_CORRECTION");
	using FPermutationDomain = TShaderPermutationDomain<FGammaCorrection>;
